...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="page-title d-flex">
            <h4 class="font-weight-semibold"><i class="icon-arrow-left52 mr-2"></i> Fund Applications Setup</h4>
        ...
        <!-- <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Fund Applications</span>
            </div>
        </div> -->
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header header-elements-sm-inline">
                    <h6 class="card-title">Fund Applications</h6>
                    <div class="header-elements">
                        <form id="newData_form" class="row">
                            <div class="">
                                <input id="fieldValue" type="text" class="form-control" placeholder="enter new application">
                            </div>
                            <button type="submit" class="btn btn-primary ml-3 "> <i class="icon icon-plus2"></i> Add New</button>
                        </form>
                    </div>
                </div>
                <div class="card-body">
...
<script >
    ...
    function getData() {
        ...
        $.ajax({
            method: 'GET',
            dataType: "json",
            url: '/setup/get_fundapplications',
    ...
    $("#newData_form").submit(function(event) {
        ...
        $.ajax({
            ...
            url: `/setup/store_fundapplication`,
            success: function(data, status, xhr) {
                console.log(data);
                getData()
                Swal.fire({
    ...
    function editRecord(id) {
        ...
        idToEdit = id;
        $('#editField').val(finder.application)
    ...
    $("#edit_form").submit(function(event) {
        ...
        $.ajax({
            ...
            data: {
                application: editField
            },
            url: `/setup/update_fundapplication/${idToEdit}`,
            success: function(data, status, xhr) {
                if (data == '-1') {
                    Swal.fire({
                        toast: true,
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    method: 'GET',
                    dataType: "json",
                    url: `/setup/delete_fundapplication/${id}`,
                    success: function(data, status, xhr) {
                        getData()
                        Swal.fire({
                            toast: true,
