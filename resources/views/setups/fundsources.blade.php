...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="page-title d-flex">
            <h4 class="font-weight-semibold"><i class="icon-arrow-left52 mr-2"></i> Fund Sources Setup</h4>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header header-elements-sm-inline">
                    <h6 class="card-title">Fund Sources</h6>
                    <div class="header-elements">
                        <form id="newData_form" class="row">
                            <div class="">
                                <input id="fieldValue" type="text" class="form-control" placeholder="enter new fund source">
                            </div>
...
<script >
    ...
    $("#edit_form").submit(function(event) {
        ...
        $.ajax({
            ...
            url: `/setup/update_fundsource/${idToEdit}`,
            success: function(data, status, xhr) {
                if (data == '-1') {
                    Swal.fire({
                        toast: true,
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    method: 'GET',
                    dataType: "json",
                    url: `/setup/delete_fundsource/${id}`,
                    success: function(data, status, xhr) {
                        getData()
                        Swal.fire({
                            toast: true,
